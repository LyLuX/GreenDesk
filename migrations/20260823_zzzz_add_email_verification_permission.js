...
const permission = {
  name: 'users.email_verification.resend',
  description: 'Renvoyer l’email de vérification d’un compte utilisateur.',
};

/** Grants the administrative resend action explicitly to the built-in administrator role. */
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.sequelize.query(
      ...
      { bind: { permissionName: permission.name, timestamp } },
    );
    await queryInterface.sequelize.query(
