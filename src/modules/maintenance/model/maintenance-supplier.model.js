...
/** Reusable supplier referenced by exact maintenance parts. */
class MaintenanceSupplier extends Model {}

MaintenanceSupplier.init(
  {
  ...
  {
    sequelize,
    modelName: 'MaintenanceSupplier',
    tableName: 'maintenance_suppliers',
    paranoid: true,
  },
);

export default MaintenanceSupplier;
