...
import MaintenanceTemplateService from '../service/maintenance-template.service.js';

export default class MaintenanceTemplateController {
  constructor(service = new MaintenanceTemplateService()) {
