...
La version actuelle de GreenDesk est **7.29.3**. Le backend, le frontend, leurs lockfiles, l’endpoint de santé et le contrat Swagger/OpenAPI utilisent la même version.
...
Les listes de sélection paginées des formulaires chargent automatiquement toutes leurs pages. Les anciens boutons `Charger plus` et leur gestion d’état ont été supprimés des pages utilisateurs, maintenance et référentiels.
